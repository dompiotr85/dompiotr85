...
- 🌱 Zawsze się uczę, aczkolwiek aktualnie odświeżam swoją wiedzę w tematyce narzędzia [CMake](https://pl.wikipedia.org/wiki/CMake) do automatycznego zarządzania procesem kompilacji programu, [Strukturalnego oraz deklaratywnego jezyka zapytań SQL](https://pl.wikipedia.org/wiki/SQL), biblioteki silnika bazy danych [SQLite](https://pl.wikipedia.org/wiki/SQLite) i współbieżnego, opertego na klasach, obiektowego języka programowania wysokiego poziomu i ogólnego zastosowania [Java](https://pl.wikipedia.org/wiki/Java). Ponadto, w końcu mogę rozwijać się korzystając z zamkniętego ekosystemu macOS i powoli rozszerzać moje projekty open source, aby w pełni obsługiwać ten system operacyjny, platformę programistyczną Xcode i być może i więcej.
